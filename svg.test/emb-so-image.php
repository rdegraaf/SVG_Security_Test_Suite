  ...
  <body id="same-origin">
    ...
    <?php
      $results = [
        ...
        "csp1.svg.test" => ["gray", "empty", "gray", "empty", "empty", "empty", "empty", "gray with gray child"], 
        "csp2.svg.test" => ["gray", "empty", "gray", "gray with gray child", "gray with gray child", "empty", "empty", "gray with gray child"], 
        "csp3.svg.test" => ["gray", "empty", "gray", "empty", "empty", "gray with gray child", "gray with gray child", "gray with gray child"], 
